...
public class FlagFragment4 extends Fragment {
    TextView t;
    MediaPlayer sound;
    TextToSpeech tts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.flag4_fragment, container, false);
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_framen, new FlagFragment5());
                //sound.stop();
               // sound.release();
                tts.stop();
                tts.shutdown();
        ...
        btn1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 * "root_fragment.xml" as the reference to replace fragment
				 */
                trans.replace(R.id.root_framen, new FlagFragment3());
              //  sound.stop();
                tts.stop();
                tts.shutdown();
