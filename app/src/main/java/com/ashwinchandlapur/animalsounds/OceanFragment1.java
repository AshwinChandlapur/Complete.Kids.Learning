...
public class OceanFragment1 extends Fragment {
    TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ocean1_fragment, container, false);
        ...
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.killerwhale);
        sound.start();
