...
public class NumberFragment7 extends Fragment {
    TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.number7_fragment, container, false);
        ...
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.number07);
        sound.start();
