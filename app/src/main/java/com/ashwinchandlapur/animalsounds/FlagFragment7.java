...
public class FlagFragment7 extends Fragment {
    TextView t;
    MediaPlayer sound;
    TextToSpeech tts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.flag7_fragment, container, false);
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_framen, new FlagFragment8());
                //sound.stop();
               // sound.release();
                tts.stop();
