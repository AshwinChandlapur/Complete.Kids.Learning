...
public class PetFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pet2_fragment, container, false);


        ImageButton btn=(ImageButton)view.findViewById(R.id.btnp2);
        ImageButton btn1=(ImageButton)view.findViewById(R.id.btn1p2);
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_framep, new PetFragment3());
