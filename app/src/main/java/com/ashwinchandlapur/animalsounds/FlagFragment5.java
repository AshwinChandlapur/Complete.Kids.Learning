...
public class FlagFragment5 extends Fragment {
    TextView t;
    MediaPlayer sound;
    TextToSpeech tts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.flag5_fragment, container, false);
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                trans.replace(R.id.root_framen, new FlagFragment6());
                //sound.stop();
               // sound.release();
                tts.stop();
        ...
        btn1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 * "root_fragment.xml" as the reference to replace fragment
				 */
                trans.replace(R.id.root_framen, new FlagFragment4());
              //  sound.stop();
                tts.stop();
