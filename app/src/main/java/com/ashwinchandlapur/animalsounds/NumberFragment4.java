...
public class NumberFragment4 extends Fragment {
    TextView t;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.number4_fragment, container, false);
        ...
        final MediaPlayer sound= MediaPlayer.create(view.getContext(),R.raw.number04);
        sound.start();
